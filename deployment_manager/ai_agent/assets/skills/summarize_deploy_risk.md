...
Output:
- 3-5 bullet summary focused on deployment safety and risks.
...
- Call out repeated changes that touch critical fields or appear across all objects, but only list up to 3.
...
- Keep it short and action-oriented; avoid repeating the same risk in multiple bullets.
